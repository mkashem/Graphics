...
void Initialize(void){
	...
	planeTexID = loadTexture((char *)"con1.jpg");   // call texture function 
	planeTexID_2 = loadTexture((char *)"map.jpg");
...
void Display(void)
{
	...
	circle_scale = glm::scale(glm::mat4(1.0f), glm::vec3(.7f, .7f, .7f));
	circle_translate = glm::translate(glm::mat4(1.0f), vec3(0.0f, -1.0f, 0.0f));;
	...
	//for hexagon
	model = mat4(1.0f);
	mat4 h_scale, h_translate;
	//circle_scale = glm::scale(glm::mat4(1.0f), glm::vec3(.7f, .7f, .7f));
	h_scale = glm::scale(glm::mat4(1.0f), glm::vec3(.7f, .7f, .7f));
	h_translate = glm::translate(glm::mat4(1.0f), vec3(-2.0f, -1.0f, 0.0f));;
	model = h_translate * h_scale;
	setMatrices();
	glBindTexture(GL_TEXTURE_2D, planeTexID_2);
	renderHexagon();
	...
	//for shpere
	model = mat4(1.0f);
	mat4 ph_scale, ph_translate;
	//circle_scale = glm::scale(glm::mat4(1.0f), glm::vec3(.7f, .7f, .7f));
	ph_scale = glm::scale(glm::mat4(1.0f), glm::vec3(.5f, .5f, .5f));
	ph_translate = glm::translate(glm::mat4(1.0f), vec3(0.0f, 1.0f, 0.0f));;
	model = ph_translate * ph_scale;
	setMatrices();
	glBindTexture(GL_TEXTURE_2D, planeTexID);
	renderSphere();
